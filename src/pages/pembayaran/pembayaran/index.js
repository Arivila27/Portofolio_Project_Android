...
const Pembayaran = (props) => {
    ...
    console.log("USE ROUTE ", route.params.idTrans )
    console.log("USE ROUTE ", route.params.nama )

    return (
        
    <View style={{flex:1}}>        
       <Tpembayaran idTrans={route.params.idTrans} namanya={route.params.nama} transBayar2={route.params.transBayar}/>
    </View>
