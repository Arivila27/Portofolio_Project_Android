    ...
    return (
        <TouchableOpacity onPress={()=>navigation.navigate('Detaillisttransaksi', {
            ...
            style={{flexDirection:'row',height:76,opacity:0.5,borderBottomWidth:0.5,marginBottom:10}}>
                ...
                <View style={{width:70,justifyContent:'center',alignItems:'center'}}>
                    {props.biliard.map((convObj, i) => {
                            if (convObj.itemNoted==='1' ||convObj.itemNoted==='open' ) {
                                return <> 
                                <View>
                                <Font14mediumhitam text="Biliard"/>
                                </View>
                                <View style={{marginTop:12}}>
                                <Font14boldhitam text={convObj.itemName}/>
                                </View>
                                </>
                            }
                        })}
...
const mapDispatchToProps = (dispatch) => {
 ...
 export default connect(mapDispatchToProps)(Listitemtransaksi)
