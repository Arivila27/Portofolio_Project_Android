...
const Escpos = ({token,infoUser,totalBayar,uangditerima,pembayaran,uangkembali,cart,datalogin,...props}) => {
    ...
    <View style={{flex:1}}>
        ...
        <ViewShot ref={cobaref}>
            <View style={{backgroundColor:myColor.putih ,padding:20,borderRadius:10}}>
                    ...
                    <Garis/>
                    <Listinformasitransaksi keys="Sub Total" value={numberFormat(totalBayar.total)}/>
                    <Listinformasitransaksi keys="PPN 10%"value={numberFormat(totalBayar.total * 10 /100)} />
                    <Garis/>

                    <Listinformasitransaksi keys="Total" value={numberFormat(totalBayar.total + totalBayar.total * 10 /100)} />
                    ...
                    <View style={{alignItems:'center',marginTop:18}}>
                        ...
                        <View style={{flexDirection:'row',marginBottom:10}}>
                            <Icon name="facebook" size={20} color={myColor.hitam}/>
                            <View style={{marginLeft:10}}>
                                <Font14mediumhitam text="@Rio Billiard And Bistro"/>
                            </View>
                        </View>
                        <View style={{flexDirection:'row',marginBottom:10}}>
...
export default connect(mapStateToProps)(Escpos)