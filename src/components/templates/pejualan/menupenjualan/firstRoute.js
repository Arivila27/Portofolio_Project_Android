...
import {View,TouchableOpacity,TextInput,FlatList, Appearance} from 'react-native';
...
const FirstRoute = ({products,cart,infoMeja}) => {
    ...
    var apaya ;
    if (query==='') {
        apaya = products.filter((s) => s.itemCategory === "MAKANAN")
